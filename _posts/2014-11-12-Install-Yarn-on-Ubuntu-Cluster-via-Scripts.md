...
The Namenode will be formated during installation. Please noted here assumes you have no HDFS exists, meaning `/var/data/hadoop/hdfs/dn` should be empty, <a href="#uninstall"><font color="red">Check how to use uninstall at the end this article</font></a>.
