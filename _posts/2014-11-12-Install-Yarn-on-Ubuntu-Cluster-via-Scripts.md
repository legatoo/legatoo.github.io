...
The Namenode will be formated during installation. Please noted here assumes you have no HDFS exists, meaning `DN_DATA_DIR` and `/var/data/hadoop/hdfs/dn` should be empty, <a href="#uninstall"><font color="red">Check how to use uninstall at the end this article</font></a>.
